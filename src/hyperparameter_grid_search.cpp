...
int main() {
    ...
    // std::vector<realtype> tau_reaction_values = {1e-1, 1e0, 1e1, 1e2, 1e3, 1e4};

    // For this search we vary the discretization factor (scales n_cells) instead of k_f,
    // and keep the tau values as before.
    ...
    filename_stream << "hyperparameter_search_results_" << std::put_time(&now_tm, "%d-%m-%Y_%H-%M") << ".npz";
    ...
    std::cout << "\nSummary:" << std::endl;
    std::cout << "- max_errors: shape (" << n_disc << ", " << n_tau << ") - 2D array" << std::endl;
    std::cout << "- solve_times: shape (" << n_disc << ", " << n_tau << ") - 2D array" << std::endl;
    std::cout << "- num_steps: shape (" << n_disc << ", " << n_tau << ") - 2D array" << std::endl;
    std::cout << "- discretization_factors: shape (" << n_disc << ") - values for axis 0" << std::endl;
    std::cout << "- tau_reaction_values: shape (" << n_tau << ") - values for axis 1" << std::endl;
