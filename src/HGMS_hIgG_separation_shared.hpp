...
// Extended signature: add discretization_factor (scales n_cells of unit
// operations). Default keeps behavior unchanged.
std::tuple<double, double, size_t> run_HGMS_hIgG_separation(
    realtype kf_ion = 1e10, realtype tau_reaction = 1, bool save_obs = true,
